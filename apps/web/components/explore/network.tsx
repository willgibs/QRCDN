 ...
 * traces, our physics). Stage is a fixed 1000×300 coordinate system scaled
 * per breakpoint so SVG paths and HTML chips never drift apart.
 */
...
function QrTile({ className }: { className?: string }) {
  const qr = brandQrStyles.precision;
  return (
    <div
      className={cn(
