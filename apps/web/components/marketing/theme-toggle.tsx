...
/**
 * Inline light/dark toggle for the marketing footer (P9-U1) — harvests
 * ExploreChrome's next-themes control (components/explore/explore-chrome.tsx)
 * but drops the fixed-FAB positioning for footer-flow placement.
 *
